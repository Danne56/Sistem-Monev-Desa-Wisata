...
export const Navbar = () => {
  ...
  const logoClass = `w-10 h-10 rounded-full ${scrolling ? "bg-black" : "bg-white"}`;
      ...
      <nav className="   2xl:py-6 py-3 px-2 h-full flex justify-between items-center">
        <div className="logo  ml-5 flex items-center py-3  ">
          <Link to="/home" className="w-40 sm:w-64 flex justify-center items-center gap-3">
            ...
            <span className="text-body font-bold ml-2">Monev</span>
          </Link>
        </div>
                ...
                <div className="absolute right-0 mt-4 min-w-[13rem] max-w-sm w-fit bg-white rounded-md shadow-lg z-10">
                  <div className="pt-5 pb-1">
                    <div className="md:text-normal text-smallText px-4 mb-2">
                      ...
                      <p className="text-[#8A8A8A] break-words whitespace-normal">{user?.data.email}</p>
                    </div>
                    <hr />
                    ...
                    {user?.data.role === "pengelola" && (
                      <Link to="/dashboard/pengelola" className="text-black flex items-center gap-3 mt-2 hover:bg-gray-100 duration-150 cursor-pointer px-4 py-2">
                        <TbNews className="md:text-2xl text-xl" />
                        <p className="font-semibold md:text-normal text-smallText ">Dashboard</p>
                      </Link>
                    )}
