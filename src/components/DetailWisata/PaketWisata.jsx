...
const placeholderImage = "https://picsum.photos/id/124/400/220";

export const PaketWisata = ({ paketWisata }) => {
  const validPaketWisata = Array.isArray(paketWisata)
    ? paketWisata.filter(Boolean)
    : [];

  const isEmpty = validPaketWisata.length === 0;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isEmpty ? (
          <div className="text-gray-600 text-center py-10">
            ...
            />
            <p className="text-lg">Belum ada paket wisata tersedia</p>
          </div>
        ) : (
